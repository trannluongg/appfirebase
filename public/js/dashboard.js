...
/***/ "./resources/js/common/common_import.js":
/*!**********************************************!*\
  !*** ./resources/js/common/common_import.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Storage = {
  ...
  setStorage: function setStorage(name) {
...
/***/ "./resources/js/components/firebase_notify/_firebase_config.js":
/*!*********************************************************************!*\
  !*** ./resources/js/components/firebase_notify/_firebase_config.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/components/firebase_notify/_firebase_notify.js":
/*!*********************************************************************!*\
  !*** ./resources/js/components/firebase_notify/_firebase_notify.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _common_common_import__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../common/common_import */ "./resources/js/common/common_import.js");
/* harmony import */ var _firebase_config__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./_firebase_config */ "./resources/js/components/firebase_notify/_firebase_config.js");
/* harmony import */ var _helpers_Http__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../helpers/Http */ "./resources/js/helpers/Http.js");
...
var FirebaseNotify = {
  ...
  runFireBaseNotify: function runFireBaseNotify() {
    var _this = this;

    firebase_app__WEBPACK_IMPORTED_MODULE_1__["default"].initializeApp(_firebase_config__WEBPACK_IMPORTED_MODULE_4__["default"]);
    var messaging = firebase_app__WEBPACK_IMPORTED_MODULE_1__["default"].messaging();
  ...
  showNotify: function showNotify(payload) {
    var _this = this,
        data = payload.data,
        notify_type = data.notify_type,
        type = data.type;
  },
  saveStorageToken: function saveStorageToken(token) {
    var _this = this;

    var storage_token = _common_common_import__WEBPACK_IMPORTED_MODULE_3__.Storage.getStorage('firebase_token');

    if (storage_token.token !== undefined) {
      var oldToken = storage_token.token,
          user_id = storage_token.user_id; // Token cũ

      if (oldToken === token) {
        // Nếu user chưa đăng nhập thì không cập nhật thông tin token
        if (AUTH === '0') return true; // Nếu user đăng nhập vào thì cập nhật lại thông tin token
  ...
  createOrUpdateToken: function createOrUpdateToken(token) {
    var oldToken = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
    _common_common_import__WEBPACK_IMPORTED_MODULE_3__.Storage.delStorage('firebase_token');
    var data = {
      token: token,
      user_id: AUTH
    };
    _common_common_import__WEBPACK_IMPORTED_MODULE_3__.Storage.setStorage('firebase_token', data);
    console.log(data);
    _helpers_Http__WEBPACK_IMPORTED_MODULE_5__["default"].post({
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (FirebaseNotify);
...
var Http = {
  ...
  send: function send(opt) {
    ...
    return jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax(data);
  }
};
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js");
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_firebase_notify_firebase_notify__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../components/firebase_notify/_firebase_notify */ "./resources/js/components/firebase_notify/_firebase_notify.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  _components_firebase_notify_firebase_notify__WEBPACK_IMPORTED_MODULE_1__["default"].init();
  Dashboard.init();
});
})();
